...
public class MFactory {
    ...
    public static function createScale3Img(texture:M3Texture):M3Image {

        var img:M3Image = GNodeFactory.createNodeWithComponent(M3Image) as M3Image;

        img.scale3Image(texture);
