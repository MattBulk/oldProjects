...
public class MTiledButton extends GComponent {
    ...
    public function init(itemClass:Class, num:uint, textureId:String, textureClass:Object = null, fontAtlas:String = MConstant.FONT_ATLAS):void {
        ...
        for(var i:uint=0; i<num; i++) {
            ...
            if(textureClass is M3Texture) button.scale3(textureClass as M3Texture, 150, 0);
            else if(textureClass is M9Texture) button.scale9(textureClass as M9Texture, 200, 150);
