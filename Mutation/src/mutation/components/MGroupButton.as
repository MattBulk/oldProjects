...
public class MGroupButton extends GComponent {
    ...
    public function init(itemClass:Class, num:uint, textureId:String, textureClass:Object = null, scaleWidth:uint = 0, scaleHeight:uint = 0, atlas:String = MConstant.FONT_ATLAS):void {
        ...
        for(var i:uint=0; i<num; i++) {
            ...
            if(textureClass is M3Texture) button.scale3(textureClass as M3Texture, scaleWidth, scaleHeight);
            else if(textureClass is M9Texture) button.scale9(textureClass as M9Texture, scaleWidth, scaleWidth);
            else button.textureId = textureId;
