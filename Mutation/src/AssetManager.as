        ...
        private function onComplete(evt:Event):void
        {
            ...
            switch (_assets[_nextToLoad].type) {
                ...
                case 3 :
                    ...
                    break;
                case 4:
                    bitmapFont = new BitmapFont((_loadedBitmap).bitmapData, _xml_data);
                    break;
            }
            ...
            if (_nextToLoad == _assets.length) {
                ...
                Genome2D.getInstance().stage.dispatchEvent(new MEvent(MEvent.LOADED, {id: "LOADED"}, true));
