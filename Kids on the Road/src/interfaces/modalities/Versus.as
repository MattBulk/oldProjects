...
public class Versus implements IModality {
    ...
    public function get theCar():TheCar {
        ...
        theCar.node.transform.setPosition(_middleTexture/1.8, 0);
    ...
    public function get rivalCar():TheRivalCar {
        ...
        theRivalCar.node.transform.setPosition((middleTexture + middleTexture/1.8), 0);
        return theRivalCar;
    }

    public function itemVector(node:GNode):Vector.<GSprite> {

        return _builder.itemsArray(node);
    }
